...
public class BTEditor : EditorWindow
{
    ...
    public void CreateGUI()
    {
        ...
        var styleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/01.Scripts/BTVisual/Editor/BTEditor.uss");
    ...
    private void OnSelectionChange()
    {
        ...
        if (tree == null) //만약 BTSO가 아니라면 혹시 게임오브젝트인지 검사
        {
            ...
            {
                var runner = Selection.activeGameObject.GetComponent<BTBrain>();
                if (runner != null)
                {
                    tree = runner.Tree;
                }
